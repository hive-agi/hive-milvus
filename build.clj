(ns build
  "hive-milvus library build: source jar + Clojars deploy.
   ...
   keep the host-integration namespaces (addon, relocate_addon,
   embed.adapter) and the addon manifest OUT of the published core so it
   stays Maven-clean.
